...
export default function EventBox({ title, subTitle }: Props) {
  ...
  return (
    <div className="relative flex flex-col">
      ...
      {isPC && (
        <div
          className={`flex top-12 absolute items-center h-32 w-12 from-[rgba(255,255,255,0)] to-[rgba(255,255,255,1)] ${isNext ? "bg-gradient-to-r justify-end right-0 " : "bg-gradient-to-l justify-start left-0"}`}
        >
          <img
